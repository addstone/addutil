 ...
 * @since 3.11
 */
public class Streams extends org.apache.commons.lang3.Streams {
    ...
    public static class FailableStream<O extends Object> {
         ...
         */
        public <R> org.apache.commons.lang3.Streams.FailableStream<R> map(final FailableFunction<O, R, ?> mapper) {
            assertNotTerminated();
            return new org.apache.commons.lang3.Streams.FailableStream<>(stream.map(Functions.asFunction(mapper)));
        }
    ...
    /**
     * Converts the given {@link Stream stream} into a {@link org.apache.commons.lang3.Streams.FailableStream}.
    ...
    /**
     * Converts the given {@link Collection} into a {@link org.apache.commons.lang3.Streams.FailableStream}.
     * This is basically a simplified, reduced version of the {@link Stream}
     * class, with the same underlying element stream, except that failable
     * objects, like {@link FailablePredicate}, {@link FailableFunction}, or
     * {@link FailableConsumer} may be applied, instead of
    ...
    public static <O extends Object> Collector<O, ?, O[]> toArray(final Class<O> pElementType) {
        return new org.apache.commons.lang3.Streams.ArrayCollector<>(pElementType);
    }
}
