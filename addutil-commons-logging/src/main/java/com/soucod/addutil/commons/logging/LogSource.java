...
import com.soucod.addutil.commons.logging.impl.NoOpLog;
 ...
 *     <code>com.soucod.addutil.commons.logging.impl.NoOpLog</code>.</li>
 * </ul>
 * <p>
 * You can change the default behavior in one of two ways:
 * <ul>
 * <li>On the startup command line, set the system property
 *     <code>com.soucod.addutil.commons.logging.log</code> to the name of the
 *     <code>com.soucod.addutil.commons.logging.Log</code> implementation class
 *     you want to use.</li>
...
public class LogSource {
    ...
    static {
        ...
        try {
            jdk14IsAvailable = null != Class.forName("java.util.logging.Logger") &&
                    null != Class.forName("com.soucod.addutil.commons.logging.impl.Jdk14Logger");
        } catch (final Throwable t) {
        ...
        String name = null;
        try {
            name = System.getProperty("com.soucod.addutil.commons.logging.log");
            if (name == null) {
                name = System.getProperty("com.soucod.addutil.commons.logging.Log");
            }
        } catch (final Throwable t) {
        ...
        if (name != null) {
            try {
                ...
                try {
                    setLogImplementation("com.soucod.addutil.commons.logging.impl.NoOpLog");
            ...
            try {
                if (log4jIsAvailable) {
                    setLogImplementation("com.soucod.addutil.commons.logging.impl.Log4JLogger");
                } else if (jdk14IsAvailable) {
                    setLogImplementation("com.soucod.addutil.commons.logging.impl.Jdk14Logger");
                } else {
                    setLogImplementation("com.soucod.addutil.commons.logging.impl.NoOpLog");
                }
            } catch (final Throwable t) {
     ...
     * value of the {@code com.soucod.addutil.commons.logging.log} property. The value
     * of {@code com.soucod.addutil.commons.logging.log} may be set to the fully specified
     ...
     * <p>
     * When {@code com.soucod.addutil.commons.logging.log} is not set, or when no corresponding
