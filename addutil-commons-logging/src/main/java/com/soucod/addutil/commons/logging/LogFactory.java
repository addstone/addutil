package com.soucod.addutil.commons.logging;

/**
 * Description:  此类描述
 *
 * @Author: addStone
 * @Date: 2021-06-07-10:18
 * UpdateDate: 2021-06-07-10:18
 * FileName: LogFactory
 */
/*
...
public abstract class LogFactory {
    ...
    /**
     * The name (<code>com.soucod.addutil.commons.logging.LogFactory</code>) of the property
     * used to identify the LogFactory implementation
     * class name. This can be used as a system property, or as an entry in a
     * configuration properties file.
     */
    public static final String FACTORY_PROPERTY = "com.soucod.addutil.commons.logging.LogFactory";

    /**
     * The fully qualified class name of the fallback <code>LogFactory</code>
     * implementation class to use, if no other can be found.
     */
    public static final String FACTORY_DEFAULT = "com.soucod.addutil.commons.logging.impl.LogFactoryImpl";
    ...
    protected static final String SERVICE_ID =
            "META-INF/services/com.soucod.addutil.commons.logging.LogFactory";

    /**
     * The name (<code>com.soucod.addutil.commons.logging.diagnostics.dest</code>)
    ...
    public static final String DIAGNOSTICS_DEST_PROPERTY =
            "com.soucod.addutil.commons.logging.diagnostics.dest";
     ...
     * (<code>com.soucod.addutil.commons.logging.LogFactory.HashtableImpl</code>)
     ...
     *     ...
     *     &lt;sysproperty
     *        key="com.soucod.addutil.commons.logging.LogFactory.HashtableImpl"
     *        value="com.soucod.addutil.commons.logging.AltHashtable"/&gt;
     *  &lt;/java&gt;
     * </pre>
     * will mean that <code>LogFactory</code> will load an instance of
     * <code>com.soucod.addutil.commons.logging.AltHashtable</code>.
     * <p>
    ...
    public static final String HASHTABLE_IMPLEMENTATION_PROPERTY =
            "com.soucod.addutil.commons.logging.LogFactory.HashtableImpl";

    /** Name used to load the weak hashtable implementation by names. */
    private static final String WEAK_HASHTABLE_CLASSNAME =
            "com.soucod.addutil.commons.logging.impl.WeakHashtable";
     ...
     * <p>
     * <ul>
     * <li>The <code>com.soucod.addutil.commons.logging.LogFactory</code> system
     *     property.</li>
     ...
     *     (<code>com.soucod.addutil.commons.logging.impl.LogFactoryImpl</code>).</li>
     * </ul>
     * <p>
            ...
            try {
                ...
                if (logFactoryClassLoader == null) {
                    ...
                    final Class factoryFromCustomLoader
                            = Class.forName("com.soucod.addutil.commons.logging.LogFactory", false, logFactoryClassLoader);
