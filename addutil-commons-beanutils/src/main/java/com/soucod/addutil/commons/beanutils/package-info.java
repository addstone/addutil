 ...
 * {@link com.soucod.addutil.commons.beanutils.PropertyUtils}
 ...
 * {@link com.soucod.addutil.commons.beanutils.PropertyUtils} class to get and set
 ...
 *
 * <ul>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#getSimpleProperty(Object, String)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#setSimpleProperty(Object, String, Object)}</li>
 * </ul>
 *
 ...
 *
 * <ul>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#getIndexedProperty(Object, String)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#getIndexedProperty(Object, String, int)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#setIndexedProperty(Object, String, Object)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#setIndexedProperty(Object, String, int, Object)}</li>
 * </ul>
 *
 ...
 *
 * <ul>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#getMappedProperty(Object, String)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#getMappedProperty(Object, String, String)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#setMappedProperty(Object, String, Object)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#setMappedProperty(Object, String, String, Object)}</li>
 * </ul>
 *
 ...
 *
 * <ul>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#getNestedProperty(Object, String)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#setNestedProperty(Object, String, Object)}</li>
 * </ul>
 *
 ...
 *
 * <ul>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#getProperty(Object, String)}</li>
 * <li> {@link com.soucod.addutil.commons.beanutils.PropertyUtils#setProperty(Object, String, Object)}</li>
 * </ul>
 *
 ...
 *
 * <p>The key to this extension mechanism is the {@link com.soucod.addutil.commons.beanutils.BeanIntrospector}
 ...
 * Per default, BeanUtils uses a {@link com.soucod.addutil.commons.beanutils.DefaultBeanIntrospector}
 ...
 * offers the {@link com.soucod.addutil.commons.beanutils.PropertyUtils#addBeanIntrospector(BeanIntrospector)}
 ...
 * implementation, BeanUtils ships with the {@link com.soucod.addutil.commons.beanutils.FluentPropertyBeanIntrospector}
 ...
 * this: {@link com.soucod.addutil.commons.beanutils.SuppressPropertiesBeanIntrospector}.
 ...
 *
 * <p>The {@link com.soucod.addutil.commons.beanutils.PropertyUtils} class described in the
 ...
 * {@link com.soucod.addutil.commons.beanutils.DynaBean} interface, which must be implemented by a
 * bean class actually implementing the interface's methods, and the associated
 * {@link com.soucod.addutil.commons.beanutils.DynaClass} interface that defines the set of
 ...
 *
 * <p>The {@link com.soucod.addutil.commons.beanutils.BasicDynaBean} and
 * {@link com.soucod.addutil.commons.beanutils.BasicDynaClass} implementation provides a
 * basic set of
 * dynamic property capabilities where you want to dynamically define the
 * set of properties (described by instances of {@link com.soucod.addutil.commons.beanutils.DynaProperty}).
 ...
 * {@link com.soucod.addutil.commons.beanutils.WrapDynaBean} (and its associated
 * {@link com.soucod.addutil.commons.beanutils.WrapDynaClass}) come into play.  As the name
 ...
 *          {@link com.soucod.addutil.commons.beanutils.DynaBean}</li>
 *     <li>2. <a href="#LazyDynaMap">LazyDynaMap</a> - A <i>light weight</i>
 *          {@link com.soucod.addutil.commons.beanutils.DynaBean} facade to a Map
 *          with <i>lazy</i> map/list processing</li>
 *     <li>3. <a href="#LazyDynaList">LazyDynaList</a> - A <i>lazy list</i>
 *          for {@link com.soucod.addutil.commons.beanutils.DynaBean DynaBean's},
 *          {@code java.util.Map}'s or POJO beans.</li>
 *     <li>4. <a href="#LazyDynaClass">LazyDynaClass</a> - A
 *          {@link com.soucod.addutil.commons.beanutils.MutableDynaClass} implementation.</li>
 * </ul>
 *
 ...
 *              {@link com.soucod.addutil.commons.beanutils.DynaClass} which implements
 *              the {@link com.soucod.addutil.commons.beanutils.MutableDynaClass}
 ...
 *              property doesn't exist then calling the {@link com.soucod.addutil.commons.beanutils.DynaBean DynaBean's}
 ...
 *     </ul>
 *
 * <p><strong>1. {@link com.soucod.addutil.commons.beanutils.LazyDynaBean}</strong> is the standard <i>lazy</i> bean
 *    implementation. By default it is associated with a {@link com.soucod.addutil.commons.beanutils.LazyDynaClass}
 *    which implements the {@link com.soucod.addutil.commons.beanutils.MutableDynaClass} interface - however
 ...
 * </pre>
 *
 * <p><strong>2. {@link com.soucod.addutil.commons.beanutils.LazyDynaMap}</strong> is a <i>light weight</i>
 ...
 * </pre>
 *
 * <p><strong>3. {@link com.soucod.addutil.commons.beanutils.LazyDynaList}</strong>
 *      is  <i>lazy list</i> for {@link com.soucod.addutil.commons.beanutils.DynaBean DynaBeans}
 *      {@code java.util.Map}'s or POJO beans. See the <a href="LazyDynaList.html">Javadoc</a>
 *      for more details and example usage.</p>
 *
 * <p><strong>4. {@link com.soucod.addutil.commons.beanutils.LazyDynaClass}</strong>
 *      extends {@link com.soucod.addutil.commons.beanutils.BasicDynaClass} and implements
 ...
 * </pre>
 *
 * <p><strong>NOTE:</strong> One feature of {@link com.soucod.addutil.commons.beanutils.MutableDynaClass} is that it
 ...
 * data type.  The {@link com.soucod.addutil.commons.beanutils.BeanUtils} class provides
 ...
 * the {@link com.soucod.addutil.commons.beanutils.ConvertUtils} class to perform the actual
 ...
 * of the {@link com.soucod.addutil.commons.beanutils.Converter} interface instead.  Therefore,
 ...
 * <ul>
 * <li>Write a class that implements the {@link com.soucod.addutil.commons.beanutils.Converter}
 ...
 * <p>The standard classes in {@code com.soucod.addutil.commons.beanutils} are not
 ...
 * <code><a href='locale/package-summary.html'>com.soucod.addutil.commons.beanutils.locale
 ...
 * <p>
 * {@code com.soucod.addutil.commons.beanutils.BeanComparator</code> is a <code>Comparator} implementation
