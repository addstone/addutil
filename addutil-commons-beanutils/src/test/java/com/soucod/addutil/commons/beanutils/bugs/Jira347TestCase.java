...
import com.soucod.addutil.commons.beanutils.memoryleaktests.MemoryLeakTestCase;
...
public class Jira347TestCase extends TestCase {
    ...
    public void testMappedPropertyDescriptor_AnyArgsProperty() throws Exception {
        final String className = "com.soucod.addutil.commons.beanutils.MappedPropertyTestBean";
