...
public class BinaryCodec implements BinaryDecoder, BinaryEncoder {
     ...
     * @see com.soucod.addutil.commons.codec.BinaryEncoder#encode(byte[])
     */
     ...
     *                  each byte represents an ASCII '0' or '1'
     * @return the raw encoded binary where each bit corresponds to a byte in the byte array argument
     * @see com.soucod.addutil.commons.codec.Decoder#decode(Object)
     */
    @Override
     ...
     * @see com.soucod.addutil.commons.codec.Encoder#encode(Object)
     */
    @Override
