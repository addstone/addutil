 ...
 * {@link com.soucod.addutil.commons.collections.sequence.EditScript edit script} containing
 * all the {@link com.soucod.addutil.commons.collections.sequence.EditCommand commands}
 * needed to transform the first sequence into the second one.
 * The entry point for the user to this algorithm is the
 * {@link com.soucod.addutil.commons.collections.sequence.SequencesComparator} class.
 * <p>
 ...
 * the {@link com.soucod.addutil.commons.collections.sequence.CommandVisitor} interface.
 * <p>
 ...
 * simple {@link com.soucod.addutil.commons.collections.sequence.ReplacementsHandler} interface,
 * using an instance of the {@link com.soucod.addutil.commons.collections.sequence.ReplacementsFinder}
 ...
 * {@link com.soucod.addutil.commons.collections.sequence.ReplacementsHandler#handleReplacement handleReplacement}
 * method is also provided. This allows the user to keep track of the current index in
 * both arrays if he needs so.
 *
 */
package com.soucod.addutil.commons.collections.sequence;
